package com.example.wildanmateritabview;
...
public class shappe_cell extends ArrayAdapter<Shape> {


    public shappe_cell(Context context, int resource, ArrayList<Shape> shappeList) {
